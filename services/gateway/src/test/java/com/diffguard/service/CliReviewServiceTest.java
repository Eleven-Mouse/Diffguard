...
/**
 * Tests for {@link CliReviewService} covering config loading,
...
@DisplayName("CliReviewService")
class CliReviewServiceTest {

    @TempDir
    Path tempDir;

    private final CliReviewService service = new CliReviewService();
