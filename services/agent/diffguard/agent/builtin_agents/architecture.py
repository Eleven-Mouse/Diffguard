"""Architecture review agent - detects design issues and structural problems."""
...
class ArchitectureAgent(ReviewAgent):
    ...
    def description(self) -> str:
        return "Detects design issues: layer violations, tight coupling, missing abstractions, SOLID violations."
