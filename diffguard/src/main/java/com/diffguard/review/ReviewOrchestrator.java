...
import com.diffguard.observability.MetricsService;
import com.diffguard.output.MarkdownFormatter;
import com.diffguard.output.ProgressDisplay;
import com.diffguard.persistence.DatabaseConfig;
import com.diffguard.persistence.ReviewResultRepository;
import com.diffguard.persistence.ReviewTaskRepository;
import com.diffguard.resilience.ResilienceService;
import com.diffguard.rules.RuleEngine;
...
public class ReviewOrchestrator implements AutoCloseable {
    ...
    private void processInternal(GitHubPayloadParser.ParsedPullRequest pr) throws Exception {
        ...
        try {
            ...
            List<DiffFileEntry> diffEntries = new com.diffguard.ast.ASTEnricher(localPath, config).enrich(rawEntries);
